...
namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        public Adventurer(string name, Robe coloredRobe)
        {
            Name = name;
            Awesomeness = 50;
        ...
        {   
            ...
            string description =$"{this.Name} is wearing robe a full {this.ColorfulRobe.Length} inches in length that is {colorsString}";
            return description;
        }
